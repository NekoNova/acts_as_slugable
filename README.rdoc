{<img src="https://travis-ci.com/coding-bunny/acts_as_slugable.svg?branch=master" alt="Build Status" />}[https://travis-ci.com/coding-bunny/acts_as_slugable]
...
<tt>gem 'acts_as_slugable', '~> 1.0.2'</tt>
